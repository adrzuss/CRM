...
import os
import json
from articulos.models import Articulo, Marca, Stock, Precio, Rubro, ArticuloCompuesto, Balance, ItemBalance, CambioPrecios, CambioPreciosItem, \
...
def enviar_remito_sucursal(idremito):
    ...
    """
    from articulos.models import EstadosRemitoSucursales
