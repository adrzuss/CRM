...
from bancos.services import BancoService, BancoPropioService
from utils.utils import check_session
from utils.msg_alertas import alertas_mensajes
import calendar

@bancos_bp.route('/bancos', methods=['GET', 'POST'])
@bancos_bp.route('/bancos/<id>', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def bancos(id=0):
...
@bancos_bp.route('/delete_banco/<id>')
def delete_banco(id):
...
@bancos_bp.route('/listado_movs_bancos', methods=['GET'])
@check_session
@alertas_mensajes
