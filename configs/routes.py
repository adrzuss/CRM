from flask import render_template, request, redirect, flash, url_for, jsonify, session, g, current_app
...
from configs.services import grabar_configuracion, save_and_update_lista_precios, grabarDatosPtoVta, validar_cuit, \
...
def permisos_menu():
    ...
    from sessions.models import OpcionesMenu
    tareas = Tareas.query.all()
...
def htmx_get_permisos_tarea():
    ...
    from sessions.models import OpcionesMenu, PermisosMenu
