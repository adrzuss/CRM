from flask import render_template, request, redirect, flash, url_for, g, jsonify
...
from entidades_cred.services import getFinanciamiento, grabarAlicuotas, calcular_coeficiente
