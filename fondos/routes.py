...
from ventas.services import get_vta_desde_hasta
from sessions.models import Usuarios
from fondos import fondos_bp
from fondos.services import obtener_total_ventas_por_tipo_ingreso, obtener_total_compras_por_tipo_ingreso, get_ventas_compras, \
...
from sessions.services import get_usuarios
from configs.services import getPuntosVta, getSucursales    
from utils.db import db
from utils.utils import check_session, format_currency
from utils.msg_alertas import alertas_mensajes

@fondos_bp.route('/caja', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def caja():
...
@fondos_bp.route('/flujoFondos', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def flujo_fondos():
    resultadosVentas = []
...
@fondos_bp.route('/rendicionCaja/<idRendicion>', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
...
@fondos_bp.route('/lst_rendiciones', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def lst_rendiciones():
    if request.method == 'GET':
