...
from ofertas.services import OfertaService
from ofertas.models import TipoOferta, TipoDescuento, ReglaSeleccion
from datetime import datetime
from decimal import Decimal

@ofertas_bp.route('/nueva_oferta', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def nueva_oferta():
...
@ofertas_bp.route('/get_referencias/<int:tipo_condicion_id>')
@check_session
...
@ofertas_bp.route('/edit/<int:id>', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def edit(id):
...
@ofertas_bp.route('/delete/<int:id>', methods=['POST'])
@check_session
@alertas_mensajes
def delete(id):
    pass
...
@ofertas_bp.route('/calcular_ofertas_de_cierre', methods=['POST'])
@check_session
@alertas_mensajes
