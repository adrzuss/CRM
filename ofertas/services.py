...
from ofertas.models import Oferta, OfertasCondiciones, TipoDescuento, TipoCondiciones, OfertasVinculadas, ReglaSeleccion
    ...
    def obtener_referencias_por_tipo(self, tipo_condicion_id):
        ...
        try:
            ...
            if tipo.nombre.lower() == 'marca':
                from articulos.models import Marca
                referencias = Marca.query.all()
            elif tipo.nombre.lower() == 'rubro':
                from articulos.models import Rubro
