# Delta para Ventas Idempotencia

> Nota: los requisitos de aplicación (aceptación de `_idempotency_key`, detección de duplicados, late assignment del correlativo, constraint compuesta) ya están especificados en el cambio `idempotencia-en-ventas` (`specs/ventas-idempotencia/spec.md`, sin archivar). Este delta agrega únicamente los requisitos de esquema y comportamiento de migración que este fix de BD implementa.
