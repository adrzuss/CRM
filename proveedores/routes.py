...
@proveedores_bp.route('/proveedores/<id>', methods=['GET'])
@check_session
@alertas_mensajes
def proveedores(id):
...
@proveedores_bp.route('/add_proveedor', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def add_proveedor():
    id = request.form['id']
...
@proveedores_bp.route('/proveedor/<id>')
@check_session
def proveedor(id):
    proveedor = db.session.get(Proveedores, id)
    if proveedor:
...
@proveedores_bp.route('/get_proveedor/<id>')
@check_session
...
@proveedores_bp.route('/get_proveedores')
@check_session
def get_proveedores():
...
@proveedores_bp.route('/delete_proveedor/<id>')
@check_session
...
@proveedores_bp.route('/nueva_compra', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def nueva_compra():
    if request.method == 'POST':
...
@proveedores_bp.route('/nuevo_gasto', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def nuevo_gasto():
    if request.method == 'POST':
...
@proveedores_bp.route('/actualizar_precios_porcompras/<id>') 
@check_session
...
@proveedores_bp.route('/get_remitos/<int:idproveedor>')
@check_session
...
@proveedores_bp.route('/remitosComp', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def remitosComp():
...
@proveedores_bp.route('/nuevo_remitoComp', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
...
@proveedores_bp.route('/ver_remito_comp/<id>') 
@check_session
@alertas_mensajes
...
@proveedores_bp.route('/ordenes_pago')
@check_session
@alertas_mensajes
def ordenes_pago():
    desde = request.args.get('desde')
...
@proveedores_bp.route('/ver_op/<int:id>')
@check_session
@alertas_mensajes
def ver_op(id):
    return redirect(url_for('proveedores.ver_factura_comp', id=id))
...
#--------------- Cuentas Corrientes ------------------
@proveedores_bp.route('/get_movs_ctacte/<int:idproveedor>')
@check_session
...
@proveedores_bp.route('/ivaCompras', methods=['GET', 'POST'])
@check_session
@alertas_mensajes
def ivaCompras():
    if request.method == 'GET':
