...
from ventas.services import get_vta_hoy, get_vta_semana, ventas_por_mes, pagos_hoy, get_operaciones_hoy, get_operaciones_semana, get_ultimas_operaciones, get_10_mas_vendidos, \
                            get_op_este_mes, get_op_este_mes_anterior, get_vta_sucursales_data, get_vta_vendedores_data, get_vta_rubros
from reportes.services import get_datos_reporte_gerencial, get_sucursales_lista
from articulos.services import get_stocks_negativos, get_stocks_faltantes
from ctactecli.services import get_saldo_clientes
from ctacteprov.services import get_saldo_proveedores
from creditos.services import get_datos_creditos
from reportes.dashboard_gerencial import (
    get_datos_dashboard,
    get_kpis,
