...
from ventas.services.wsaa import LoginTicket  # Asumiendo que tienes el código anterior en wsaa.py

from configs.models import PuntosVenta, Configuracion
from configs.services import discrimina_iva_afip
