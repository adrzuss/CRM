...
import uuid
from articulos.services import actualizarStock, get_articulo_by_codigo
from configs.services import discrimina_iva

from utils.utils import format_currency, precio, convertir_decimal
from ventas.models import Factura, Item, PagosFV, ControlNc, Presupuesto, ItemP, PresupuestoFactura, RemitosVtaFactura
from clientes.models import Clientes
from articulos.models import Articulo, ListasPrecios, Stock, Colores, DetallesArticulos
from entidades_cred.models import MovEntidades
from ctactecli.models import CtaCteCli
from configs.models import Configuracion, PagosCobros, AlcIva, AlcIB, PuntosVenta, TipoComprobantes, TipoIva, \
...
from ventas.services.facturador import Facturador
from ventas.services.generar_factura import generar_factura_pdf
        ...
        for key, value in form.items():
            ...
            if response['success'] == True:
                if key.startswith('items') and key.endswith('[codigo]'):
                    ...
                    # Capturar costo unitario para cálculo de comisiones
                    costo_unitario = articulo.costo if articulo.costo else 0
